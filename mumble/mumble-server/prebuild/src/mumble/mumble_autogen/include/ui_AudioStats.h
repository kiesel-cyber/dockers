...
public:
    ...
    {
        AudioStats->setWindowTitle(QApplication::translate("AudioStats", "Audio Statistics", nullptr));
        qgbInput->setTitle(QApplication::translate("AudioStats", "Input Levels", nullptr));
        qliMicLevel->setText(QApplication::translate("AudioStats", "Peak microphone level", nullptr));
#ifndef QT_NO_TOOLTIP
        qlMicLevel->setToolTip(QApplication::translate("AudioStats", "Peak power in last frame", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qlMicLevel->setWhatsThis(QApplication::translate("AudioStats", "This shows the peak power in the last frame (20 ms), and is the same measurement as you would usually find displayed as \"input power\". Please disregard this and look at <b>Microphone power</b> instead, which is much more steady and disregards outliers.", nullptr));
#endif // QT_NO_WHATSTHIS
        qlMicLevel->setText(QString());
        qliSpeakerLevel->setText(QApplication::translate("AudioStats", "Peak speaker level", nullptr));
#ifndef QT_NO_TOOLTIP
        qlSpeakerLevel->setToolTip(QApplication::translate("AudioStats", "Peak power in last frame", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        ...
        qliSignalLevel->setText(QApplication::translate("AudioStats", "Peak clean level", nullptr));
#ifndef QT_NO_TOOLTIP
        qlSignalLevel->setToolTip(QApplication::translate("AudioStats", "Peak power in last frame", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qlSignalLevel->setWhatsThis(QApplication::translate("AudioStats", "This shows the peak power in the last frame (20 ms) after all processing. Ideally, this should be -96 dB when you're not talking. In reality, a sound studio should see -60 dB, and you should hopefully see somewhere around -20 dB. When you are talking, this should rise to somewhere between -5 and -10 dB.<br />If you are using echo cancellation, and this rises to more than -15 dB when you're not talking, your setup is not working, and you'll annoy other users with echoes.", nullptr));
#endif // QT_NO_WHATSTHIS
        qlSignalLevel->setText(QString());
        qgbSignal->setTitle(QApplication::translate("AudioStats", "Signal Analysis", nullptr));
        qliMicVolume->setText(QApplication::translate("AudioStats", "Microphone power", nullptr));
#ifndef QT_NO_TOOLTIP
        qlMicVolume->setToolTip(QApplication::translate("AudioStats", "How close the current input level is to ideal", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qlMicVolume->setWhatsThis(QApplication::translate("AudioStats", "This shows how close your current input volume is to the ideal. To adjust your microphone level, open whatever program you use to adjust the recording volume, and look at the value here while talking.<br /><b>Talk loud, as you would when you're upset over getting fragged by a noob.</b><br />Adjust the volume until this value is close to 100%, but make sure it doesn't go above. If it does go above, you are likely to get clipping in parts of your speech, which will degrade sound quality.", nullptr));
#endif // QT_NO_WHATSTHIS
        qlMicVolume->setText(QString());
        qliMicSNR->setText(QApplication::translate("AudioStats", "Signal-To-Noise ratio", nullptr));
#ifndef QT_NO_TOOLTIP
        qlMicSNR->setToolTip(QApplication::translate("AudioStats", "Signal-To-Noise ratio from the microphone", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qlMicSNR->setWhatsThis(QApplication::translate("AudioStats", "This is the Signal-To-Noise Ratio (SNR) of the microphone in the last frame (20 ms). It shows how much clearer the voice is compared to the noise.<br />If this value is below 1.0, there's more noise than voice in the signal, and so quality is reduced.<br />There is no upper limit to this value, but don't expect to see much above 40-50 without a sound studio.", nullptr));
#endif // QT_NO_WHATSTHIS
        qlMicSNR->setText(QString());
        qliSpeechProb->setText(QApplication::translate("AudioStats", "Speech Probability", nullptr));
#ifndef QT_NO_TOOLTIP
        qlSpeechProb->setToolTip(QApplication::translate("AudioStats", "Probability of speech", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qlSpeechProb->setWhatsThis(QApplication::translate("AudioStats", "This is the probability that the last frame (20 ms) was speech and not environment noise.<br />Voice activity transmission depends on this being right. The trick with this is that the middle of a sentence is always detected as speech; the problem is the pauses between words and the start of speech. It's hard to distinguish a sigh from a word starting with 'h'.<br />If this is in bold font, it means Mumble is currently transmitting (if you're connected).", nullptr));
#endif // QT_NO_WHATSTHIS
        qlSpeechProb->setText(QString());
        qgbConfiguration->setTitle(QApplication::translate("AudioStats", "Configuration feedback", nullptr));
        qliBitrate->setText(QApplication::translate("AudioStats", "Current audio bitrate", nullptr));
#ifndef QT_NO_TOOLTIP
        qlBitrate->setToolTip(QApplication::translate("AudioStats", "Bitrate of last frame", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qlBitrate->setWhatsThis(QApplication::translate("AudioStats", "This is the audio bitrate of the last compressed frame (20 ms), and as such will jump up and down as the VBR adjusts the quality. The peak bitrate can be adjusted in the Settings dialog.", nullptr));
#endif // QT_NO_WHATSTHIS
        qlBitrate->setText(QString());
        qliDoublePush->setText(QApplication::translate("AudioStats", "DoublePush interval", nullptr));
#ifndef QT_NO_TOOLTIP
        qlDoublePush->setToolTip(QApplication::translate("AudioStats", "Time between last two Push-To-Talk presses", nullptr));
#endif // QT_NO_TOOLTIP
        qlDoublePush->setText(QString());
        qliSpeech->setText(QApplication::translate("AudioStats", "Speech Detection", nullptr));
#ifndef QT_NO_TOOLTIP
        abSpeech->setToolTip(QApplication::translate("AudioStats", "Current speech detection chance", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        abSpeech->setWhatsThis(QApplication::translate("AudioStats", "<b>This shows the current speech detection settings.</b><br />You can change the settings from the Settings dialog or from the Audio Wizard.", nullptr));
#endif // QT_NO_WHATSTHIS
        qgbSpectrum->setTitle(QApplication::translate("AudioStats", "Signal and noise power spectrum", nullptr));
#ifndef QT_NO_TOOLTIP
        anwNoise->setToolTip(QApplication::translate("AudioStats", "Power spectrum of input signal and noise estimate", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        anwNoise->setWhatsThis(QApplication::translate("AudioStats", "This shows the power spectrum of the current input signal (red line) and the current noise estimate (filled blue).<br />All amplitudes are multiplied by 30 to show the interesting parts (how much more signal than noise is present in each waveband).<br />This is probably only of interest if you're trying to fine-tune noise conditions on your microphone. Under good conditions, there should be just a tiny flutter of blue at the bottom. If the blue is more than halfway up on the graph, you have a seriously noisy environment.", nullptr));
#endif // QT_NO_WHATSTHIS
        qgbEcho->setTitle(QApplication::translate("AudioStats", "Echo Analysis", nullptr));
#ifndef QT_NO_TOOLTIP
        aewEcho->setToolTip(QApplication::translate("AudioStats", "Weights of the echo canceller", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        aewEcho->setWhatsThis(QApplication::translate("AudioStats", "This shows the weights of the echo canceller, with time increasing downwards and frequency increasing to the right.<br />Ideally, this should be black, indicating no echo exists at all. More commonly, you'll have one or more horizontal stripes of bluish color representing time delayed echo. You should be able to see the weights updated in real time.<br />Please note that as long as you have nothing to echo off, you won't see much useful data here. Play some music and things should stabilize. <br />You can choose to view the real or imaginary parts of the frequency-domain weights, or alternately the computed modulus and phase. The most useful of these will likely be modulus, which is the amplitude of the echo, and shows you how much of the outgoing signal is being removed at that time step. The other viewing modes are mostly useful to people who want to tune the echo cancellation algorithms.<br />Please note: If the entire image fluctuates massively while in modulus mode, the echo canceller fails to find any co"
                        "rrelation whatsoever between the two input sources (speakers and microphone). Either you have a very long delay on the echo, or one of the input sources is configured wrong.", nullptr));
#endif // QT_NO_WHATSTHIS
    } // retranslateUi
